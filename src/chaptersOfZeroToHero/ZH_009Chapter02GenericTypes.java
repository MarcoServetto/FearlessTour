...
Fork : {
  .chooseInt(leftRight: LeftRightInt): Int;
  .choosePoint(leftRight: LeftRightPoint): Point;
  .chooseDirection(leftRight: LeftRightDirection): Direction;
  ...
  }
